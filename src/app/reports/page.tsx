                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
                        <h3 className="text-lg font-medium text-blue-600 truncate">
                          {stat.vehicle.nickname || `${stat.vehicle.year} ${stat.vehicle.make} ${stat.vehicle.model}`}
                        </h3>
                        {stat.lastEntry && (
                          <p className="mt-1 text-sm text-gray-500">
                            Last Reading: {new Date(stat.lastEntry.date).toLocaleDateString()} - {stat.lastEntry.odometer.toLocaleString()} miles
                          </p>
                        )}
                      </div>
                      <div className="ml-4 flex-shrink-0">
                        ...
                        <p className="text-xs text-gray-500">
                          {stat.averageMilesPerDay.toFixed(1)} miles/day
                        </p>
                      </div>
                    </div>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        {stat.entries} readings in selected period
                      </p>
                    </div>
                  </div>
                </li>
